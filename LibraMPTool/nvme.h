...
typedef struct _ADMIN_CREATE_IO_SUBMISSION_QUEUE_DW10
{
     ...
     * created. Refer to section 4.1.3. This is a 0 based value.
     */
    USHORT  QSIZE;
...
typedef struct _ADMIN_GET_LOG_PAGE_COMMAND_DW11
{
	ULONG	NUMDU	 :16;
	ULONG	Reserved :16;
} ADMIN_GET_LOG_PAGE_COMMAND_DW11, *PADMIN_GET_LOG_PAGE_COMMAND_DW11;

typedef struct _ADMIN_GET_LOG_PAGE_COMMAND_DW12
{
	ULONG	LPOL;
} ADMIN_GET_LOG_PAGE_COMMAND_DW12, *PADMIN_GET_LOG_PAGE_COMMAND_DW12;

typedef struct _ADMIN_GET_LOG_PAGE_COMMAND_DW13
{
	ULONG	LPOU;
} ADMIN_GET_LOG_PAGE_COMMAND_DW13, *PADMIN_GET_LOG_PAGE_COMMAND_DW13;
...
#define DEVICE_SELF_TEST			0x06
#define RESERVATION_NOTIFICATION	0x80
#define SANITIZE_STATUS				0x81
...
typedef struct _NVM_GET_LOG_PAGE_SMART_HEALTH_INFORMATION_LOG_ENTRY
{
     ...
     * based on the actual device usage and the manufacturer prediction of
...
typedef struct _NVM_GET_VENDOR_SPECIFIC_SMART_INFORMATION_ENTRY
{
    USHORT  ThermalThrottleStatus;
    ULONG		EndtoEndCyclicRedundancyCheckEventCount;
    ULONG		LinkCyclicRedundancyCheckEventCount;
    
    UCHAR Reserved2[502];
} ADMIN_GET_VENDOR_SPECIFIC_SMART_INFORMATION_ENTRY,
  *PADMIN_GET_VENDOR_SPECIFIC_SMART_INFORMATION_ENTRY;

typedef struct _NVM_GET_EXTENDED_SMART_LOG_ENTRY
{
    UCHAR ReassignedSectorCount;
    UCHAR ProgramFailCountWorstCaseComponent;
    UCHAR ProgramFailCountSSDTotal;
    UCHAR EraseFailCountWorstCaseComponent;
    UCHAR EraseFailCountSSDTotal;  
    UCHAR WearLevelingCount;
    UCHAR UsedReservedBlockCountWorstCaseComponent;
    UCHAR UsedReservedBlockCountSSDTotal;
    ULONG ReservedBlockCount;                    
    UCHAR Reserved2[500];
} ADMIN_GET_EXTENDED_SMART_LOG_ENTRY,
  *PADMIN_GET_EXTENDED_SMART_LOG_ENTRY;
...
typedef struct _ADMIN_IDENTIFY_CONTROLLER
{
    ...
    */
     ...
     * section 5.1). This is a 0 based value. It is recommended that
     ...
     * commands supported by the controller (see section 5.2). This is a 0
     ...
     * NVMHCI power states supported by the controller. This is a 0 based
...
//    UCHAR   Reserved2[247];
	...
	struct
	{
		UCHAR   SupportsCryptoErase  :1;
		UCHAR   SupportsBlockErase	 :1;
		UCHAR   SupportsOverwrite	 :1;
		ULONG   Reserved             :29;
	} SANICAP;
	UCHAR   Reserved2[180];
     ...
     * logical blocks and is a 0 based value. If a write is issued of this
     ...
     * in logical blocks and is a 0 based value. If a write is issued of this
...
typedef struct _ADMIN_IDENTIFY_NAMESPACE
{
     ...
     * sequentially. This is a 0 based value. The maximum number of LBA
    ...
    struct
    {
         ...
         * this data structure. This is a 0 based value.
         */
...
typedef struct _ADMIN_SET_FEATURES_COMMAND_DW11
{
    /*
     * [Feature Identifier] his field indicates the identifier of the Feature
     * that attributes are being specified for.
     */
    ULONG   DW11      :32;
} ADMIN_SET_FEATURES_COMMAND_DW11, *PADMIN_SET_FEATURES_COMMAND_DW11;
...
typedef struct _ADMIN_SET_FEATURES_COMMAND_ARBITRATION_DW11
{
     ...
     * arbitration round. This is a 0 based value.
     */
    UCHAR   MPW;
...
typedef struct _ADMIN_SET_FEATURES_COMMAND_LBA_RANGE_TYPE_DW11
{
     ...
     * specified in this command. This is a 0 based value.
     */
    ULONG   NUM      :6;
    ULONG   Reserved :26;
...
typedef struct _ADMIN_SET_FEATURES_COMMAND_LBA_RANGE_TYPE_ENTRY
{
     ...
     * blocks that are part of this LBA range. This is a 0 based value.
     */
    ULONGLONG   NLB;
...
typedef struct _ADMIN_SET_FEATURES_COMMAND_NUMBER_OF_QUEUES_DW11
{
     ...
     * that the minimum support is for one I/O Completion Queue. This is a 0
     * based value.
     */
    ULONG   NCQR     :16;
     ...
     * that the minimum support is for one I/O Submission Queue. This is a 0
     * based value.
     */
    ULONG   NSQR     :16;
...
typedef struct _ADMIN_SET_FEATURES_COMPLETION_NUMBER_OF_QUEUES_DW0
{
     ...
     * software. This is a 0 based value.
     */
    ULONG   NCQA     :16;
...
typedef struct _ADMIN_DEVICE_SELF_TEST_COMMAND_DW10
{
    /*
     * [Number of Dwords] This field specifies the number of Dwords in the image
     */
	ULONG   STC			:4;
	ULONG	Reserved	:28;
} ADMIN_DEVICE_SELF_TEST_COMMAND_DW10,
  *PADMIN_DEVICE_SELF_TEST_COMMAND_DW10;
...
typedef struct _ADMIN_SANITIZE_COMMAND_DW10
{	
    ULONG   SANACT      :3;
	ULONG	AUSE		:1;
	ULONG	OWPASS		:4;
	...
	ULONG	NDAS		:1;
	ULONG   Reserved    :22;
} ADMIN_SANITIZE_COMMAND_DW10, *PADMIN_SANITIZE_COMMAND_DW10;

/* Security Receive Command, Section 5.14, Figure 93 */
typedef struct _ADMIN_SANITIZE_COMMAND_DW11
{
    /*
     * [Transfer Length] The value of this field is specific to the Security
     * Protocol as defined in SPC-4.
     */
    ULONG   OVRPAT;
} ADMIN_SANITIZE_COMMAND_DW11, *PADMIN_SANITIZE_COMMAND_DW11;
 ...
 * queue base address and size, ?the value written is the same as the
...
typedef struct _NVM_WRITE_COMMAND_DW10
{
    ULONG	SLBA;
} NVM_WRITE_COMMAND_DW10, *PNVM_WRITE_COMMAND_DW10;

typedef struct _NVM_WRITE_COMMAND_DW11
{
    ULONG	SLBA;
} NVM_WRITE_COMMAND_DW11, *PNVM_WRITE_COMMAND_DW11;
...
typedef struct _NVM_WRITE_COMMAND_DW12
{
    /*
     * [Number of Logical Blocks] This field indicates the number of logical
     * blocks to be written.  This is a 0 based value.
     */
    USHORT  NLB;
    USHORT  Reserved    :10;
...
typedef struct _NVM_WRITE_COMMAND_DW14
{
    ULONG	ILBRT;
} NVM_WRITE_COMMAND_DW14, *PNVM_WRITE_COMMAND_DW14;
...
typedef struct _NVM_READ_COMMAND_DW10
{
    ULONG	SLBA;
} NVM_READ_COMMAND_DW10, *PNVM_READ_COMMAND_DW10;

typedef struct _NVM_READ_COMMAND_DW11
{
    ULONG	SLBA;
} NVM_READ_COMMAND_DW11, *PNVM_READ_COMMAND_DW11;
...
typedef struct _NVM_READ_COMMAND_DW12
{
    /*
     * [Number of Logical Blocks] This field indicates the number of logical
     * blocks to be read.  This is a 0 based value.
     */
    USHORT  NLB;
    USHORT  Reserved    :10;
...
typedef struct _NVM_READ_COMMAND_DW14
{
    ULONG	SLBA;
} NVM_READ_COMMAND_DW14, *PNVM_READ_COMMAND_DW14;
...
typedef struct _NVM_WRITE_UNCORRECTABLE_COMMAND_DW10
{
    /*
     * [Number of Logical Blocks] This field indicates the number of logical
     * blocks to be marked as invalid.  This is a 0 based value.
     */
    ULONG  LSLBA;
} NVM_WRITE_UNCORRECTABLE_COMMAND_DW10, *PNVM_WRITE_UNCORRECTABLE_COMMAND_DW10;

typedef struct _NVM_WRITE_UNCORRECTABLE_COMMAND_DW11
{
    /*
     * [Number of Logical Blocks] This field indicates the number of logical
     * blocks to be marked as invalid.  This is a 0 based value.
     */
    ULONG  USLBA;
} NVM_WRITE_UNCORRECTABLE_COMMAND_DW11, *PNVM_WRITE_UNCORRECTABLE_COMMAND_DW11;
...
typedef struct _NVM_COMPARE_COMMAND_DW10
{
	ULONG LSLBA;
} NVM_COMPARE_COMMAND_DW10, *PNVM_COMPARE_COMMAND_DW10;

typedef struct _NVM_COMPARE_COMMAND_DW11
{
	ULONG USLBA;
} NVM_COMPARE_COMMAND_DW11, *PNVM_COMPARE_COMMAND_DW11;
...
typedef struct _NVM_COMPARE_COMMAND_DW12
{
    /*
     * [Number of Logical Blocks] This field indicates the number of logical
     * blocks to be compared.  This is a 0 based value.
     */
    USHORT  NLB;
    USHORT  Reserved    :10;
...
typedef struct _NVM_COMPARE_COMMAND_DW14
{
	ULONG EILBRT;
} NVM_COMPARE_COMMAND_DW14, *PNVM_COMPARE_COMMAND_DW14;
...
typedef struct _NVM_DATASET_MANAGEMENT_COMMAND_DW10
{
     ...
     * specified in the command.  This is a 0 based value.
     */
    ULONG   NR       :8;
    ULONG   Reserved :24;
