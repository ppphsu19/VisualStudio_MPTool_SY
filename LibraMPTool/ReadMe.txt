================================================================================
    MFC 程式庫 : LibraMPTool 專案概觀
===============================================================================

應用程式精靈已經為您建立了這個 LibraMPTool 應用程式。這個應用程式
不僅示範了使用 MFC 的基本概念，也是您撰寫應用程式的起點。

這個檔案的內容摘要，包含各個構成 LibraMPTool 應用程式的檔案。
...
LibraMPTool.h
    ...
    並宣告 CLibraMPToolApp 應用程式類別。

LibraMPTool.cpp
    這是主要的應用程式原始程式檔，它包含應用程式類別 CLibraMPToolApp。
...
LibraMPToolDlg.h、LibraMPToolDlg.cpp - 對話方塊
    這些檔案包含您的 CLibraMPToolDlg 類別。這個類別定義應用程式主
    對話方塊的行為。對話方塊的範本在 LibraMPTool.rc 內，您可以 
...
StdAfx.h、StdAfx.cpp
    這些檔案是用來建置名為 LibraMPTool.pch 的先行編譯標頭 (PCH) 檔，
